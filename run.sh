...
(cd artifacts/api-server && PORT="$PORT_API" MONGODB_URI="$MONGODB_URI" OPENROUTER_API_KEY="$OPENROUTER_API_KEY" MENTOR_TIP_OPENROUTER_API_KEY="$MENTOR_TIP_OPENROUTER_API_KEY" FASHN_API_KEY="$FASHN_API_KEY" TRYON_ENGINE="$TRYON_ENGINE" pnpm run dev) &
API_PID=$!
